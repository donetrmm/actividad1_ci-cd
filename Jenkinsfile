pipeline {
    ...
    environment {
        ...
        SERVER_DEV = 'IP1'  // IP del servidor 1
        SERVER_QA = 'IP2'   // IP del servidor 2
        SERVER_PROD = 'IP3' // IP del servidor 3
        DEPLOY_USER = 'ubuntu'    // Usuario para SSH
        APP_DIR = '/home/ubuntu/nombre-carpeta' // Directorio de la aplicación en el servidor
        REPOSITORY = 'https://github.com/donetrmm/auth-service.git' // Repositorio Git
    }
